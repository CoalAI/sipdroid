...
public class Settings extends PreferenceActivity implements OnSharedPreferenceChangeListener, OnClickListener {
	...
	public static final String	DEFAULT_USERNAME = "demo1";
	public static final String	DEFAULT_PASSWORD = "demo1";
	public static final String	DEFAULT_SERVER = "sip.invictasoft.pt";
	public static final String	DEFAULT_DOMAIN = "";
	public static final String	DEFAULT_FROMUSER = "Pedro";
		...
		if (key.startsWith(PREF_PORT) && sharedPreferences.getString(key, DEFAULT_PORT).equals("0")) {
    		...
    		for (int i = 0; i < 1; i++) {
    			...
    			if (key.equals(PREF_SERVER+j)) {
    				...
    				lp.setValue(sharedPreferences.getString(PREF_SERVER+j, DEFAULT_SERVER).equals(DEFAULT_SERVER) ? "5060" : DEFAULT_PORT);
    			}
    			if (key.equals(PREF_PROTOCOL+j)) {
    				if (sharedPreferences.getString(PREF_SERVER+j, DEFAULT_SERVER).equals(DEFAULT_SERVER)) {
    					...
    					lp.setValue(sharedPreferences.getString(PREF_PROTOCOL+j, DEFAULT_PROTOCOL).equals("tls") ? "5070" : "5060");
    				} else {
